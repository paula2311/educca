...
<section class="teachers">
    ...
    <div class="box-container">
        <div class="box offer">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos repellendus corrupti repudiandae doloremque eligendi voluptates.</p>

            <a href="admin/register.php"><button  class="inline-btn">get started</button></a> 
        </div>
        <?php
